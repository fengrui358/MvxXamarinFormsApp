...
namespace MvxXamarinFormsApp.Core.UI.HybridWeb
{
    /// <summary>
    /// The hybrid web view.
    /// </summary>
    public class HybridWebView : View
    {
        ...
        /// The navigating
        /// </summary>
        public EventHandler<MvxValueEventArgs<Uri>> Navigating;
        ...
        /// The JSON serializer.
        /// </summary>
        private readonly IMvxJsonConverter jsonSerializer;
        ...
        public HybridWebView(IMvxJsonConverter jsonSerializer)
        {
        ...
        public void CallJsFunction(string funcName, params object[] parameters)
        {
            ...
            {
                builder.Append(this.jsonSerializer.SerializeObject(parameters[n]));
        ...
        {
            this.Navigating?.Invoke(this, new MvxValueEventArgs<Uri>(uri));
        }

        internal void MessageReceived(string message)
        {
            var m = this.jsonSerializer.DeserializeObject<Message>(message);
